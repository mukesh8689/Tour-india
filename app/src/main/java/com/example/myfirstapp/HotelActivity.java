...
public class HotelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetSongs().execute("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+lat + "," + lon + "&radius=1500&type="+nam+"&key=AIzaSyBLEPBRfw7sMb73Mr88L91Jqh3tuE4mKsE");
    ...
    private class GetSongs extends AsyncTask<String,Void,String> {
        ...
        protected void onPreExecute() {
            ...
            progress_bar = new ProgressDialog(HotelActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            RecycleViewAdapter3 myAdapter = new RecycleViewAdapter3(HotelActivity.this,thotel);
